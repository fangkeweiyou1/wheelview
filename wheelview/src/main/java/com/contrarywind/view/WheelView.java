    ...
    protected void onDraw(Canvas canvas) {
        ...
        while (counter < itemsVisible) {
            ...
            if (angle >= 90F || angle <= -90F) {
                ...
                if (TextUtils.equals(tag, "month_tag")) {
                    if (!TextUtils.isEmpty(contentText)) {
                        if (contentText.contains("01")) {
                            contentText="January";
                        } else if (contentText.contains("02")) {
                            contentText="February";
                        } else if (contentText.contains("03")) {
                            contentText="March";
                        } else if (contentText.contains("04")) {
                            contentText="April";
                        } else if (contentText.contains("05")) {
                            contentText="May";
                        } else if (contentText.contains("06")) {
                            contentText="June";
                        } else if (contentText.contains("07")) {
                            contentText="July";
                        } else if (contentText.contains("08")) {
                            contentText="August";
                        } else if (contentText.contains("09")) {
                            contentText="September";
                        } else if (contentText.contains("10")) {
                            contentText="October";
                        } else if (contentText.contains("11")) {
                            contentText="November";
                        } else if (contentText.contains("12")) {
